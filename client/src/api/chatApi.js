...
export const searchUsers = ({ exclude, query }) =>
  ...
  return fetch(`/api/messages/${Number(messageId)}`, {
    method: "DELETE",
    headers: {
...
export function getChatMembers(chatId) {
  return fetch(`/api/chats/${Number(chatId)}/members`, {
    method: "GET",
    credentials: "include",
  });
}

export function updateChatMemberRole({ chatId, userId, role }) {
  return fetch(`/api/chats/${Number(chatId)}/members/${Number(userId)}/role`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export function removeChatMemberRequest({ chatId, userId }) {
  return fetch(`/api/chats/${Number(chatId)}/members/${Number(userId)}/remove`, {
    method: "POST",
    credentials: "include",
  });
}

export function editMessage({ messageId, username, body }) {
  return fetch(`/api/messages/${Number(messageId)}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
...
export const sendMessage = (payload) =>
  ...
  apiFetch(`${API_BASE}/api/messages/${encodeURIComponent(messageId)}`, {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
  });
...
export const deletePendingMessage = (clientId) =>
  ...
  export const deleteMessage = (messageId, payload) =>
  apiFetch(`${API_BASE}/api/messages/${encodeURIComponent(messageId)}`, {
    method: "DELETE",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
